...
public class C01_deque {
    public static void main(String[] args) {
        ...
        // A'yi son kullanildigi yerden sildi

        System.out.println(harfler); // [A, g, K, e, K]
        // sondaki A silindikten sonra listenin son hali

        System.out.println(harfler.removeLastOccurrence("X")); // false
        //olmayan bir harfi silmesini istersek bize false dondurur.
        System.out.println(harfler); // [A,g, K, e, K]
        ...
        System.out.println(harfler.element());// g'yi getirdi ama g'yi listeden silmez
        System.out.println(harfler); // [g, K, e]
