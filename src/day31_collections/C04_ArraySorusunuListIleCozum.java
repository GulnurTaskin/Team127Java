...
public class C04_ArraySorusunuListIleCozum {
    public static void main(String[] args) {
        ...
        for (int i=0; i <arr.length ; i ++){
            ...
            if (! tekrarsizList.contains(arr[i])){ // i, arraydeki elementler. eger benim listem bu elementi icermiyorsa
                tekrarsizList.add(arr[i]);  // o zaman tekrarsizList'e i'yi ekle
